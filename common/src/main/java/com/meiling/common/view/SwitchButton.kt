...
class SwitchButton @JvmOverloads constructor(
    ...
    /** 开启状态背景色 */
    private var accentColor: Int = Color.parseColor("#FD4B48")

    /** 开启状态按钮描边色 */
    private var primaryDarkColor: Int = Color.parseColor("#FD4B48")

    /** 关闭状态描边色 */
    private var offColor: Int = Color.parseColor("#C4C4C4")
