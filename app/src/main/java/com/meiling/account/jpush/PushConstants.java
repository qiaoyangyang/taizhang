...
//    public static final String APP_KEY = "应用申请的Appkey";
    public static final String APP_KEY = "6433b3f63dc02524084fe923";//正式

    /**
     * 应用申请的UmengMessageSecret
     */
    public static final String MESSAGE_SECRET = "63f258c4df805f33e00cb48d4d1988d4";//正式

    /**
     * 后台加密消息的密码（仅Demo用，请勿将此密码泄漏）
     */
    public static final String APP_MASTER_SECRET = "gmmsxkf5wspmuixnlbdu6ald1q29qqmc";
