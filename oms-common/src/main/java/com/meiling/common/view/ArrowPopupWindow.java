...
//        mViewContainer.setId(popup_text_container);
...
//        arrowImage.setId(popup_arraw);
        ...
        switch (mArrowDirection) {
            case LEFT:
                r = 180;
                textContainerParams.addRule(RelativeLayout.END_OF);
                break;
            case TOP:
                r = 270;
                textContainerParams.addRule(RelativeLayout.BELOW);
                break;
            case BOTTOM:
                r = 90;
                arrowParams.addRule(RelativeLayout.BELOW);
                break;
            case RIGHT:
                r = 0;
                arrowParams.addRule(RelativeLayout.END_OF);
                break;
        }
