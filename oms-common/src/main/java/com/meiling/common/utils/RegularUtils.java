...
public class RegularUtils {
    ...
    private static final String REGEX_TEL_phone = "(010\\d{8})|(0[2-9]\\d{9})|(13\\d{9})|(14[57]\\d{8})|(15[0-35-9]\\d{8})|(18[0-35-9]\\d{8})";
    /**
     * 验证邮箱
     */
     ...
     * @return 是否符合邮箱格式
     */
    public static boolean REGEX_TEL_phone(String string) {
        return isMatch(REGEX_TEL_phone, string);
    }
    /**
     * @param string 待验证文本
     * @return 是否符合邮箱格式
